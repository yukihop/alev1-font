...
export const visualPresets: VisualPreset[] = [
  ...
  },
  {
    ...
    color: '#000000',
    shadow:
      'drop-shadow(0 0 0.08em rgba(255, 104, 104, 0.95)) drop-shadow(0 0 0.24em rgba(255, 104, 104, 0.62))',
    sample: 'asahi',
  },
  {
    value: 'fuyuko-paper',
    ...
    color: '#000000',
    shadow:
      'drop-shadow(0 0 0.08em rgba(127, 242, 140, 0.95)) drop-shadow(0 0 0.24em rgba(127, 242, 140, 0.62))',
    sample: 'fuyuko',
  },
  {
    value: 'mei-paper',
    ...
    color: '#000000',
    shadow:
      'drop-shadow(0 0 0.08em rgba(255, 97, 184, 0.95)) drop-shadow(0 0 0.24em rgba(255, 97, 184, 0.62))',
    sample: 'mei',
  },
  {
    value: 'alev1-paper',
    ...
    color: '#000000',
    shadow:
      'drop-shadow(0 0 0.055em rgba(68, 220, 255, 0.9)) drop-shadow(0 0 0.18em rgba(68, 220, 255, 0.45))',
    sample: 'i',
  },
  {
    value: 'gold-paper',
    ...
    color: '#000000',
    shadow:
      'drop-shadow(0 0 0.055em rgba(255, 196, 61, 0.9)) drop-shadow(0 0 0.18em rgba(255, 196, 61, 0.45))',
    sample: 'human',
  },
  {
    value: 'plain-ink',
...
export function getKeywordSuggestions(prefix: string, keywordList: string[]): string[] {
  ...
  return keywordList
    .filter(keyword => keyword.startsWith(normalizedPrefix) && keyword !== normalizedPrefix)
    .slice(0, 8);
}
