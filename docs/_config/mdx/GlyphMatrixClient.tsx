...
const GlyphMatrixClient: FC<GlyphMatrixProps> = props => {
                    ...
                    <td key={hex}>
                      {glyph ? (
                        <>
                          ...
                          >
                            <div className="glyph-popover-meta">
                              <CopyPillButton
                                className="hex-pill glyph-popover-copy"
                                copyId={glyph.hex}
                              ...
                              />
                              <CopyPillButton
                                className="binary-pill glyph-popover-copy"
                                copyId={glyph.hex}
                            ...
                            {glyph.keywords.length > 0 ? (
                              <div className="glyph-popover-keywords">
                                {glyph.keywords.map(keyword => (
                                  <CopyPillButton
                                    key={keyword}
                                    className="keyword-pill glyph-popover-copy"
                                    copyId={glyph.hex}
                                    copyValue={keyword}
                                    text={keyword}
                                    onCopy={copyText}
                            ...
                            {glyph.comment ? <div className="glyph-popover-comment">{glyph.comment}</div> : null}
                            {copiedId === glyph.hex ? (
                              <div className="glyph-popover-copy-status" aria-live="polite">
                                Copied
                              </div>
                            ) : null}
                          </div>
